...
const Attraction = () => {
  ...
  const handleSubmit = (evt) => {
    evt.preventDefault();
    attractionService.getAttraction(formData.city).then((attractionData) => {
      ...
      <div className="attraction-ctn">
        {attractions?.map((attraction) => (
          <div key={attraction.id} className="attractions">
            ...
            <img src={attraction.images[9].url} alt="attraction-images" />
            <br />
            <h2 className="idea-info">
              Date: {attraction.dates.start.localDate}
            </h2>
            <h2 className="idea-info">
              Time: {attraction.dates.start.localTime}
            </h2>
